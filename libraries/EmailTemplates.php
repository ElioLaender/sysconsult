...
class EmailTemplates {
    ...
    #template de envio de mensagem para o paciente
    public function messagetPacient($nomeRem,$telRem,$emailRem,$urlRem,$assunto,$mensagem){
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/354125d804a5aa788ef824ec2/images/e9d948e6-cba4-4a32-889e-e3c72a4c343a.jpg" width="564" style="max-width:1000px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1>Mensagem de '.$nomeRem.'</h1>
<br>
<span style="font-size:22px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><strong>'.$assunto.'</strong></span></span><br>
<br>
'.$mensagem.'<br>
<br>
<strong>Atanção! Este e-mail não deve ser respondido. </strong>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
                    ...
                    <td align="center" valign="top" style="padding-top:9px; padding-right:9px; padding-left:9px;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                ...
                                <br>Segue abaixo os contatos para retorno, obrigado!
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <span style="font-size:16px"><em>Em caso de dúvidas estamos a disposição para lhe auxiliar.</em><br><br>&nbsp;<br>
Nome: '.$nomeRem.'&nbsp;<br>
Contato: '.$telRem.'&nbsp;<br>
Email: '.$emailRem.'&nbsp;<br>
<a href="'.$urlRem.'" target="_blank">Entre em contato pelo site!</a></span>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
