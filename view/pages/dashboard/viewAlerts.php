    ...
    <aside id="sidebar" class="sidebar c-overflow">
        <div class="profile-menu">
         ...
         <ul class="main-menu">
            ...
            <li class="active"><a href="?controller=Dashboard&action=viewAlerts"><i class="tm-icon zmdi zmdi-notifications"></i> Notificações (<?php echo $qtdNotifi; ?>)</a></li>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Minhas mensagens <small>Clique em responder para dar um retorno para o potencial paciente.</small></h2>
                </div>
