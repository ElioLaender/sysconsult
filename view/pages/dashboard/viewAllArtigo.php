                    ...
                    <ul>
                        <li class="sub-menu active toggled">
                            ...
                            <ul>
                                ...
                                <li><a class="active" href="?controller=Blog&action=viewArtigos">Visualizar Artigos</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Artigos publicados <small>Clique nas opções para editar ou excluir os artigos postados.</small></h2>
                </div>
