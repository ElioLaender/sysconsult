        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>Pacientes recentes <small>Clique para ver seus novos pacientes e adicione informações ao prontuário.</small></h2>
                            <ul class="actions">
                                <li class="dropdown">
                                    <a href="" data-toggle="dropdown">
                                        <i class="zmdi zmdi-more-vert"></i>
                    ...
                    <div id="todo-lists">
                        <div class="emBreve">
                            <p>Em breve, sua lista de tarefas!</p>
                        </div>
                        <div class="tl-header">
                            <h2>Lista de tarefas</h2>
                            <small>Adicione tareras e organize melhor sua rotina</small>
                        ...
                        <div class="tl-body">
                            <div id="add-tl-item">
                                ...
                                <div class="add-tl-body">
                                    <textarea placeholder="Escreva sua tarefa aqui..."></textarea>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header ch-alt m-b-20">
                            <h2>Ultimas mensagens <small>Veja as ultimas mensagens</small></h2>

                            <a href="?controller=Dashboard&action=viewMessage"><button class="btn bgm-cyan btn-float"><i class="zmdi zmdi-plus"></i></button></a>
                        </div>
