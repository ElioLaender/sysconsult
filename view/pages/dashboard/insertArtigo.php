                ...
                <li class="sub-menu active toggled">
                    ...
                    <ul>
                        <li class="sub-menu active toggled">
                            ...
                            <ul>
                                <li><a class="active" href="?controller=Blog&action=viewInsertArtigo">Criar Novo Artigo</a></li>
    ...
    <section id="content">
        <div class="container">
            <div class="block-header">
                <h2><a href="?controller=Dashboard&action=viewDashBoard"> Início <i class="zmdi zmdi-chevron-right"> </i></a>  <strong><a href="">Inserir Artigo</a></strong></h2>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <!-- -->
                    <form method="post" action="?controller=Blog&action=insertArtigo"  enctype="multipart/form-data">

                        <div class="card-body card-padding">

                            <h2>Escrever artigo<small>Publique seu artigo e passe mais valores para seus pacientes</small></h2>
                            <br/><br/>
                            <div class="col-sm-4" >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="titulo" class="form-control" placeholder="Assunto">
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body card-padding">
                                            ...
                                            <div class="form-group">
                                                <div class="fg-line">
                                                    <textarea class="form-control auto-size" name="texto" placeholder="Digite as observações..."></textarea>
                                                </div>
                                            </div>

                                        </div>

                                    <input type="hidden" name="serRef" value="">
                                    <br/><br/>
                                    <button type="submit" class="btn btn-primary btn-lg waves-effect">Publicar artigo</button>
