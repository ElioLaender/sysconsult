   ...
   <aside id="sidebar" class="sidebar c-overflow">
        <div class="profile-menu">
         ...
         <ul class="main-menu">
                ...
                <li class="active"><a href="?controller=Admin&action=viewServices"><i class="zmdi zmdi-hospital"></i> Gerenciar Serviços</a></li>
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                   ...
                   if(!empty($tableService)){
                       echo "<h2>Lista dos seus planos <small>Vesualize, altere ou adicione mais planos.</small></h2>";
                       echo $tableService;
                   } else{
                       echo "<h2>Nenhum plano cadastrado <small>Cadastre os seus serviços e seja encontrado por futuros pacientes.</small></h2>";
                   }
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Novo Plano<small>Adicione novos planos e conquiste mais pacientes</small></h2>
                    <!-- -->
                    <form method="post" action="?controller=Admin&action=newService"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="nomePla" class="form-control" value="" placeholder="Nome do Serviço">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="precoPla" class="form-control" value="" placeholder="Preço">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-collection-item-1"></i></span>
                                        <div class="fg-line">
                                            <input type="text" name="list1" class="form-control" value="" placeholder="Descrição 01">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-collection-item-2"></i></span>
                                        <div class="fg-line">
                                            <input type="text" name="list2" class="form-control" value="" placeholder="Descrição 02">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-collection-item-3"></i></span>
                                        <div class="fg-line">
                                            <input type="text" name="list3" class="form-control" value="" placeholder="Descrição 03">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-collection-item-4"></i></span>
                                        <div class="fg-line">
                                            <input type="text" name="list4" class="form-control" value="" placeholder="Descrição 04">
                                        </div>
                                    </div>
                                    <br/>
                                    <br/><br/>
