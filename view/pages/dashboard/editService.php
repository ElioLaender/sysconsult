        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Editar Plano<small>Modifique as informações e clique em salvar alterações.</small></h2>
                    <!-- -->
                    <form method="post" action="?controller=Admin&action=serviceUpdate"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="nome" class="form-control" value="<?php echo $dataService[0]['servico_nome']; ?>" placeholder="Nome do plano">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="preco" class="form-control" value="<?php echo $dataService[0]['servico_preco']; ?>" placeholder="Preço">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="list1" class="form-control" value="<?php echo $dataService[0]['servico_list1']; ?>" placeholder="Descrição 01">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="list2" class="form-control" value="<?php echo $dataService[0]['servico_list2']; ?>" placeholder="Descrição 02">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="list3" class="form-control" value="<?php echo $dataService[0]['servico_list3']; ?>" placeholder="Descrição 03">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="list4" class="form-control" value="<?php echo $dataService[0]['servico_list4']; ?>" placeholder="Descrição 04">
                                        </div>
                                    </div>
                                    <br/>
                                    <input type="hidden" name="serRef" value="<?php echo $dataService[0]['servico_id']; ?>"
                                    <br/><br/>
