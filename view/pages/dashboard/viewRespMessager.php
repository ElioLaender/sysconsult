...
<head>
        ...
        <title>Painel SysConsulte</title>
    ...
    <section id="content">
        <div class="container">
            <div class="block-header">
                <h2><a href="?controller=Dashboard&action=viewMessage">caixa de mensagens <i class="zmdi zmdi-chevron-left"> </i></a>  <strong><a href="">Responder</a></strong></h2>
            </div>

            <div class="card">
                <div class="card-header">
                    <h2>Mensagem<small>Mensagem recebida pelo formulário de contato do site.</small></h2>

                    <div class="card-header">

                        <div>
                            <span><i class="zmdi zmdi-calendar"> </i> Recebida em - <?php echo $dataMessage[0]['contato_data_recebimento']; ?></span>

                        </div>
                        <br/><br/>
                        <div>
                            <span><i class="zmdi zmdi-account"> </i> Nome - <?php echo $dataMessage[0]['contato_nome']; ?></span>
                        </div>
                        <br/><br/>
                        <div>
                            <span><i class="zmdi zmdi-email"> </i> Email - <?php echo $dataMessage[0]['contato_email']; ?></span>

                        </div>
                        <br/><br/>
                        <div>
                            <span><i class="zmdi zmdi-comment-alt-text"> </i> Assunto - <?php echo $dataMessage[0]['contato_assunto']; ?></span>

                        </div>
                        <br/><br/>
                        <div>
                            <span><i class="zmdi zmdi-collection-text"> </i> Mensagem: </span>
                            <p><br/><?php echo $dataMessage[0]['contato_mensagem']; ?></p>
                        </div>
                        <br/>
                    ...
                    <!-- -->
                    <form method="post" action="?controller=Email&action=respMessageHome"  enctype="multipart/form-data">

                        <div class="card-body card-padding">

                            <h2>Responder<small>Sua mensagem será direcionada para a caixa de email do usuário.</small></h2>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <br/>  <br/>
                                            <textarea class="form-control" rows="5"  name="mensagem" placeholder="Digite sua mensagem"></textarea>
                                        </div>
                                    </div>
                                    	<input type="hidden" name="emailDes" value="<?php echo $dataMessage[0]['contato_email']; ?>" />
					<input type="hidden" name="nomeDes" value="<?php echo $dataMessage[0]['contato_nome']; ?>" />	
					<input type="hidden" name="nomeAdm" value="<?php echo $userData[0]['admin_nome']; ?>" />
					<input type="hidden" name="telAdm" value="<?php echo $userData[0]['admin_tel']; ?>" />
					<input type="hidden" name="emailAdm" value="<?php echo $userData[0]['admin_email']; ?>" />
					<input type="hidden" name="ref" value="<?php echo $dataMessage[0]['contato_id']; ?>" />
				
                                    <br/><br/>
                                    <button type="submit" class="btn btn-primary btn-lg waves-effect">Enviar resposta</button>
