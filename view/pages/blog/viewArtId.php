...
<section class="sectArtic">
    <div class="contArtic">
        <div>
            ...
            <?php
               echo '<article style="width: 100%; border:none;">
                <img src="'.$artigo[0]['artigo_ft_capa'].'" style="width: 35%; margin-left:30%; border-radius: 50%; box-shadow: 5px 9px 3px #bdc3c7; border:none;">
                <div style="width:100%">

                </div>
                <h3 style="width:100%; font-weight: bold; ">'.$artigo[0]['artigo_titulo'].'</h3>
                    <p style="width:100%; text-align:left">
                        '.nl2br($artigo[0]['artigo_texto']).'
                    </p>
            </article>';
